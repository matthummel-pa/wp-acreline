Acreline — WordPress theme pack
================================

Extract this zip first. Do not upload this whole file into WordPress.

  acreline.zip          Appearance → Themes → Upload Theme (inner zip)
...
Install
-------
  1. WordPress 6.6+ and PHP 8.3+.
  2. Upload acreline.zip and activate Acreline.
  3. Keep the folder named acreline.
  4. Customize → Identity and Site Identity (logo).
  5. Optional: acreline-child.zip, then acreline-core.zip.
  6. Tools → Seed Acreline demo for sample pages.
...
License:  GPLv2 or later (theme). Sage/Acorn MIT.
