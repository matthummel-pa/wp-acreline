    ...
    <ol class="guide-checklist" role="list">
      <li class="guide-checklist__item">
        ...
        <div class="guide-checklist__body">
          <strong>{{ __('Water source — well or municipal?', 'acreline') }}</strong>
      ...
      <li class="guide-checklist__item">
        ...
        <div class="guide-checklist__body">
          <strong>{{ __('Septic — existing system or percolation required?', 'acreline') }}</strong>
      ...
      <li class="guide-checklist__item">
        ...
        <div class="guide-checklist__body">
          <strong>{{ __('Road access — deeded or by permission?', 'acreline') }}</strong>
      ...
      <li class="guide-checklist__item">
        ...
        <div class="guide-checklist__body">
          <strong>{{ __('Zoning and agricultural enrollments', 'acreline') }}</strong>
      ...
      <li class="guide-checklist__item">
        ...
        <div class="guide-checklist__body">
          <strong>{{ __('Survey — does one exist?', 'acreline') }}</strong>
      ...
      <li class="guide-checklist__item">
        ...
        <div class="guide-checklist__body">
          <strong>{{ __('Flood zone and drainage', 'acreline') }}</strong>
      ...
      <li class="guide-checklist__item">
        ...
        <div class="guide-checklist__body">
          <strong>{{ __('Mineral rights — included or severed?', 'acreline') }}</strong>
      ...
      <li class="guide-checklist__item">
        ...
        <div class="guide-checklist__body">
          <strong>{{ __('Financing — land loan or conventional?', 'acreline') }}</strong>
