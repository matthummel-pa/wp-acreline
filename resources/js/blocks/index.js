...
registerBlockType('acreline/newsletter', {
    ...
    description: __('Weekly listings digest band. Demo confirm stays on the page.', 'acreline'),
    category: 'acreline',
    icon: 'email-alt',
    supports: acreSupports,
    attributes: {
        ...
        return el(SsrEdit, {
            ...
            sidebarFn: () => el(Fragment, null,
                el(PanelBody, { title: __('Copy', 'acreline'), initialOpen: true },
                    ...
                    el(TextControl, { label: __('Title', 'acreline'), value: a.title, onChange: (v) => s({ title: v }) }),
                    el(TextareaControl, { label: __('Text', 'acreline'), value: a.text, onChange: (v) => s({ text: v }) }),
                    el(TextControl, { label: __('Cadence stamp', 'acreline'), value: a.cadence, onChange: (v) => s({ cadence: v }), help: __('Small masthead pill. Leave blank to hide.', 'acreline') }),
                ...
                el(PanelBody, { title: __('Layout', 'acreline'), initialOpen: true },
                    el(SelectControl, {
                        label: __('Layout', 'acreline'),
                        value: a.layout || 'digest',
                        options: [
                            { value: 'digest',  label: __('Digest + listing teasers (default)', 'acreline') },
                            { value: 'split',   label: __('Split + form card',                 'acreline') },
                    ...
                    el(SelectControl, {
                        ...
                        options: [
                            ...
                            { value: 'flush', label: __('Flush on the band', 'acreline') },
                        ],
                    ...
                    el(ToggleControl, { label: __('Show listing teasers', 'acreline'), checked: a.showTeasers !== false, onChange: (v) => s({ showTeasers: v }), help: __('Hidden automatically on the compact bar.', 'acreline') }),
                    el(ToggleControl, { label: __('Show form benefits', 'acreline'), checked: a.showBenefits !== false, onChange: (v) => s({ showBenefits: v }) }),
                ...
                el(PanelBody, { title: __('Listing teasers', 'acreline'), initialOpen: false },
                    el(TextControl, { label: __('Teasers label', 'acreline'), value: a.teasersLabel, onChange: (v) => s({ teasersLabel: v }) }),
                    el(SelectControl, {
                        label: __('Source', 'acreline'),
                        value: a.teaserSource || 'featured',
                        options: [
                            { value: 'featured', label: __('Featured listings (blank rows fill in)', 'acreline') },
                            { value: 'custom',   label: __('Custom rows only',                       'acreline') },
                        ],
                        onChange: (v) => s({ teaserSource: v }),
                    }),
                    ...[1, 2, 3].map((n) => el(Fragment, { key: n },
                        el(TextControl, { label: `${__('Address', 'acreline')} ${n}`, value: a[`teaser${n}Title`] || '', onChange: (v) => s({ [`teaser${n}Title`]: v }) }),
                        el(TextControl, { label: `${__('Meta', 'acreline')} ${n}`, value: a[`teaser${n}Meta`] || '', onChange: (v) => s({ [`teaser${n}Meta`]: v }) }),
                        el(TextControl, { label: `${__('Price', 'acreline')} ${n}`, value: a[`teaser${n}Price`] || '', onChange: (v) => s({ [`teaser${n}Price`]: v }) }),
                        el(TextControl, { label: `${__('Link', 'acreline')} ${n}`, value: a[`teaser${n}Url`] || '', onChange: (v) => s({ [`teaser${n}Url`]: v }), type: 'url' }),
                    )),
                ),
                el(PanelBody, { title: __('Form benefits', 'acreline'), initialOpen: false },
                    el(TextControl, { label: __('Benefit 1', 'acreline'), value: a.benefit1, onChange: (v) => s({ benefit1: v }) }),
                    el(TextControl, { label: __('Benefit 2', 'acreline'), value: a.benefit2, onChange: (v) => s({ benefit2: v }) }),
                    el(TextControl, { label: __('Benefit 3', 'acreline'), value: a.benefit3, onChange: (v) => s({ benefit3: v }) }),
                ),
                el(BandPanel, { attrs: a, s }),
                el(TypographyPanel, { attrs: a, s }),
            ),
...
// ---------------------------------------------------------------------------
// 34. Custom Block (acreline/custom — from Block Generator)
// ---------------------------------------------------------------------------
